...
# do IHA
model_loflows <- group2(model_flows, yearType = "calendar")
gage_loflows <- group2(gage_flows, yearType = "calendar")
gage_loflows_all <- group2(gage_flows_all, yearType = "calendar")
...
gfa <- hydrotools::group2(gage_flows_all, yearType = "calendar")
...
```{r l1-barplot, fig.width=7, fig.height=4.8, dev='png', echo=FALSE}
