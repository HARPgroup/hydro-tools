...
#Salem EXTENT
extent = data.frame(x = c(-80.25, -79.75),y = c(37.10, 37.50))
...
ggsave(plot = minorbasin_map, file = paste0(export_path, "tables_maps/Xfigures/","salem_minorbasin_map.png",sep = ""), width=6.5, height=4.95)
######################################################################################################
######################################################################################################
