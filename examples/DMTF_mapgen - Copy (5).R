...
for (w in 1:length(wells[,1])) {
  ...
  well_w_geom <- geom_sf(data = well_w_sf,aes(geometry = geom,colour = color_list[2]), shape=17, inherit.aes = FALSE,size=3)
...
LakeMoomaw_geom <- geom_sf(data = LakeMoomaw_sf,aes(geometry = geom,colour = "black"), inherit.aes = FALSE,size=1.25,linetype = "11")
...
SmithMountainLake_geom <- geom_sf(data = SmithMountainLake_sf,aes(geometry = geom,colour = "black"), inherit.aes = FALSE,size=1.25,linetype = "11")
...
LakeAnna_geom <- geom_sf(data = LakeAnna_sf,aes(geometry = geom,colour = "black"), inherit.aes = FALSE,size=1.25,linetype = "11")
...
KerrReservoir_geom <- geom_sf(data = KerrReservoir_sf,aes(geometry = geom,colour = "black"), inherit.aes = FALSE,size=1.25,linetype = "11")
