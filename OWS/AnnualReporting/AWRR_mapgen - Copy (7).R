...
# 
# #layer.sf <- st_as_sf(layer.df, wkt = 'fips_geom')
# layer.sf <- st_as_sf(rbs, wkt = 'fips_geom')
# layer.gg <- geom_sf(data = layer.sf,aes(geometry = fips_geom),color = 'blue',lwd=0.4, inherit.aes = FALSE, show.legend = TRUE)
