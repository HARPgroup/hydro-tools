...
# Loading previously generated gage location maps
library(magick)
gis_img <- image_read(paste0(file.path(hydro_tools, "HARP-2018", "DEQ_Model_vs_USGS_Comparison", "gage_locations", siteNo), ".jpg"))
gis_img <- image_resize(gis_img, geometry_size_percent(60))
```
...
---
title: "`r paste(siteNo, "vs.", RivSeg)`"
author: "Daniel Hildebrand, Hailey Alspaugh, and Kelsey Reitz"
date: "July 11, 2018"
output:
  pdf_document: default
