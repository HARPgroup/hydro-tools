...
wayside <- subset(wayside, varkey=="wl_mgd" & year(wayside$Date)==yoi)
spholla <- subset(spholla, varkey=="wl_mgd" & year(spholla$Date)==yoi)
...
vahydro$way_cfs <- vahydro$way_val * unit_conv
