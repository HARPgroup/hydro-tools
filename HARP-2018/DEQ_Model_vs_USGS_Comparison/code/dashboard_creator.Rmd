...
container <- "C:\\Users\\Daniel\\Documents\\HARP\\DEQ_Model_vs_USGS_Comparison_v1.0"

# USGS Gage number
siteNo <- "03164000"

# Should new or original data be used?
new.or.original <- "original"
```
...
# GIS ------
gis_img_path <- paste0(container, "\\gage_locations\\", siteNo, ".jpg")
gis_img <- image_read(gis_img_path)
image_scale(gis_img, "x.5")
